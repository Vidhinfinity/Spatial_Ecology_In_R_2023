...
The next step will allow us to select the language (r) and whether the code will give results (yes), and then we tap Knit to see the preview. 
...
Using proper packages: the imageRy package has been built for learning purposes (library is written in red as it's a function)
```{r, eval = T} 
library(imageRy)
```
